...
public class EjemploAutomovil {
    public static void main(String[] args) {
        ...
        System.out.println("\nMertodo Kilometros por litro");
        System.out.println("Kilometros por litro " +
                subaru.calcularConsumo(300, 0.6f));

        System.out.println("Kilometros por litro " +
                subaru.calcularConsumo(300, 60));

        System.out.println("Kilometros por litro " +
                nissan.calcularConsumo(300, 60));
