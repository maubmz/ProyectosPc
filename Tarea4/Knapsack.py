...
class Cosas():
    ...
    ##  El valor sera obtenido dividiendo el precio entre el peso
...
#arregloCosas.append(Cosas('Los relojes Blandos. Dali',250,6,0))
#arregloCosas.append(Cosas('Calendario Maya',456,9,0))
#arregloCosas.append(Cosas('DVD',110,2,0))
#arregloCosas.append(Cosas('Busto Platon',300,10,0))
#arregloCosas.append(Cosas('Adorno',70,3,0))


## Esta parte corresponde a la busqueda exhaustiva
inicio = time.time()
...
print(len(arregloCosas))
## Fin de la busqueda exhaustiva
